    ...
    return (
      <React.Fragment>
        <div class = "container-fluid" style={{height: "100vh"}}>
            <Text><p>I'm Kola. I'm a PhD student at <a href = "https://mtl.stanford.edu" target="_blank">Stanford</a>. I was a Faculty Research Assistant at the <a href="https://mith.umd.edu/" target="_blank">University of Maryland, College Park</a>.</p>
            <p>⬤</p>
            ...
            <p>kolaheywardrotimi at gmail.com</p></Text>
          </div>
      </React.Fragment>
    );
  }
